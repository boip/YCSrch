...
<div class="crumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="#"><fmt:message key="userProfile.title"/></a>
		</li>
	</ul>
</div>
...
<div class="col-md-7">
    ...
    <form:form commandName="user" method="post" action="userform" id="userForm" autocomplete="off"
        ...
        <c:if test="${empty user.version}">
            <input type="hidden" name="encryptPass" value="true"  class="form-control"/>
        </c:if>
    ...
    <c:if test="${cookieLogin != 'true'}">
        ...
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
            ...
            <div class="controls">
                <form:password path="password" id="password" showPassword="true"  cssClass="form-control"/>
        ...
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
            ...
            <div class="controls">
                <form:password path="confirmPassword" id="confirmPassword" showPassword="true"  cssClass="form-control"/>
        ...
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
            ...
            <div class="controls">
                <form:input path="firstName" id="firstName" maxlength="50"  cssClass="form-control"/>
        ...
        <fieldset>
            ...
            <div id="collapse-address" class="accordion-body collapse">
                <fieldset class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="address.address" id="address.address"  cssClass="form-control"/>
                    </div>
                </fieldset>
                <fieldset class="control-group">
                ...
                <fieldset class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="address.province" id="address.province"  cssClass="form-control"/>
                    </div>
                </fieldset>
                <fieldset class="control-group">
                    <appfuse:label styleClass="control-label" key="user.address.postalCode"/>
                    <div class="controls">
                        <form:input path="address.postalCode" id="address.postalCode"  cssClass="form-control"/>
                    </div>
                </fieldset>
                <fieldset class="control-group">
