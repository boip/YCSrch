    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          orphan: false,
          basePath: "",
          template: "<div class='popover'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <div class='popover-content'></div>          <nav class='popover-navigation'>            <div class='btn-group'>              <button class='btn btn-xs btn-blue' data-role='prev'>&laquo; 上一条</button>              <button class='btn btn-xs btn-blue' data-role='next'>下一条 &raquo;</button>            </div>            <button class='btn btn-xs btn-danger' data-role='end'>不看了</button>          </nav>        </div>",
